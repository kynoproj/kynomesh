...
[![Go Report Card](https://goreportcard.com/badge/github.com/kynoproj/kynomesh)](https://goreportcard.com/report/github.com/kynoproj/kynomesh)
...
agent-to-agent (A2A) traffic — so you can focus on the agent logic instead of
the wiring.
