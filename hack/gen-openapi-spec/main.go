...
func main() {
	...
	dependencies := []string{}
	for defName, val := range kmv1.GetOpenAPIDefinitions(referenceCallback) {
...
// e.g.:
// github.com/kynoproj/kynomesh/pkg/apis/kynomesh/v1alpha1/AgentSet
// to:
// sh.kyno.kynomesh.v1alpha1.AgentSet
func swaggify(name string) string {
	name = strings.ReplaceAll(name, "github.com/kynoproj/kynomesh/pkg/apis/kynomesh", "kynomesh.kyno.sh")
