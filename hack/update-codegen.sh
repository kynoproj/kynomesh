...
THIS_PKG="github.com/kynoproj/kynomesh"
...
#    --output-dir "${REPO_ROOT}/pkg/apis/kynomesh/v1alpha1" \
#    --output-pkg "github.com/kynoproj/kynomesh/pkg/apis/kynomesh/v1alpha1" \
