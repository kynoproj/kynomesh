...
You can find the most recent version under
[Github Releases](https://github.com/kynoproj/kynomesh/releases).
...
Kynomesh does not use Semantic Versioning. Minor versions may contain breaking
changes. Patch versions only contain bug fixes and minor features.
