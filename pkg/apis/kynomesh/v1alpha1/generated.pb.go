...
func (m *AgentSetSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ExternalAgents) > 0 {
		for iNdEx := len(m.ExternalAgents) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.ExternalAgents[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *ExternalAgentRef) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ExternalAgentRef) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ExternalAgentRef) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *AgentSetSpec) Size() (n int) {
	...
	if len(m.ExternalAgents) > 0 {
		for _, e := range m.ExternalAgents {
			l = e.Size()
			n += 1 + l + sovGenerated(uint64(l))
		}
	}
...
func (m *ExternalAgentRef) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *AgentDeploySpec) String() string {
	...
	s := strings.Join([]string{`&AgentDeploySpec{`,
		...
		`Topology:` + strings.Replace(strings.Replace(this.Topology.String(), "Topology", "Topology", 1), `&`, ``, 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *AgentSetSpec) String() string {
	...
	repeatedStringForExternalAgents := "[]ExternalAgentRef{"
	for _, f := range this.ExternalAgents {
		repeatedStringForExternalAgents += strings.Replace(strings.Replace(f.String(), "ExternalAgentRef", "ExternalAgentRef", 1), `&`, ``, 1) + ","
	}
	repeatedStringForExternalAgents += "}"
...
func (this *ExternalAgentRef) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ExternalAgentRef{`,
		`Name:` + fmt.Sprintf("%v", this.Name) + `,`,
...
func (this *Topology) String() string {
	...
	for _, f := range this.Peers {
		repeatedStringForPeers += strings.Replace(strings.Replace(f.String(), "Peer", "Peer", 1), `&`, ``, 1) + ","
	}
	repeatedStringForPeers += "}"
	s := strings.Join([]string{`&Topology{`,
		`Pattern:` + fmt.Sprintf("%v", this.Pattern) + `,`,
		`IsEntry:` + fmt.Sprintf("%v", this.IsEntry) + `,`,
...
func (m *AgentSetSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ExternalAgents", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ExternalAgents = append(m.ExternalAgents, ExternalAgentRef{})
			if err := m.ExternalAgents[len(m.ExternalAgents)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *ExternalAgentRef) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ExternalAgentRef: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ExternalAgentRef: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *Peer) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Kind = PeerKind(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field URL", wireType)
...
func (m *Topology) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field IsEntry", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
