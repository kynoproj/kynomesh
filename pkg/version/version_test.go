...
func TestVersionStringOutput(t *testing.T) {
	v := Version{
		Version:      "1.0.1",
		BuildDate:    "2026-01-01T12:00:00Z",
	...
	expected := "Version: 1.0.1, BuildDate: 2026-01-01T12:00:00Z, GitCommit: abcdef1234567890, GitTag: v1.0.1, GitTreeState: clean, GoVersion: go1.26, Compiler: gc, Platform: linux/amd64"
...
func TestGetVersionWithCleanTreeAndTag(t *testing.T) {
	...
	if v.Version != "v1.2.1" {
		t.Errorf("GetVersion().Version = %v, want v1.2.1", v.Version)
	}
}
