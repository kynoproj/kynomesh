...
// GetDefaults returns the controller-scope default config. A nil receiver
// (no configmap wired in, e.g. in unit tests) yields the zero DefaultConfig,
// so callers can always call GetDefaultContainerResources() on the result.
