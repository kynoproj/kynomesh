...
import (
	...
	commontls "github.com/kynoproj/kynomesh/pkg/shared/tls"
	"github.com/kynoproj/kynomesh/pkg/webhook/validator"
)
...
type AdmissionController struct {
	...
	KynomeshClient v1alpha1.KynomeshV1alpha1Interface
...
func (ac *AdmissionController) admit(ctx context.Context, request *admissionv1.AdmissionRequest) *admissionv1.AdmissionResponse {
	...
	v, err := validator.GetValidator(ctx, ac.KynomeshClient, request.Kind, request.OldObject.Raw, request.Object.Raw)
	if err != nil {
